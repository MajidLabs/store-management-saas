...
| Automation | GitHub Actions | Real CI (`ci.yml`, §24) on every push/PR - lint, unit, e2e against real service containers, both builds; plus the scheduled database-backup workflow (`backup.yml`, §20) |
